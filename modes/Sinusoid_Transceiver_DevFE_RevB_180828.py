...
class Sinusoid_Transceiver_DevFE_RevB_180828:
    ...
    def doSimpleRxTx(self):
        ...
        # activate
        IrisUtil.Process_TxActivate_WriteFlagAndDataToTxStream_UseHasTime(self, delay = 10000000)
        IrisUtil.Process_RxActivate_WriteFlagToRxStream_UseHasTime(self, rx_delay = 57, delay = 10000000)
